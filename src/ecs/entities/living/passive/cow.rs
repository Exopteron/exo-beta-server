...
pub struct CowEntityBuilder;
impl CowEntityBuilder {
    pub fn build<'a>(
        ...
        builder.add(CowEntity);
        builder.add(EnumMobType::Cow);
    ...
    pub fn cow_saver(entity: &EntityRef) -> anyhow::Result<CompoundTag> {
