...
pub struct CreeperEntityBuilder;


impl CreeperEntityBuilder {
    pub fn build<'a>(
        ...
        builder.add(CreeperEntity);
        builder.add(EnumMobType::Creeper);
    ...
    pub fn creeper_saver(entity: &EntityRef) -> anyhow::Result<CompoundTag> {
