...
impl Item for WaterBucketItem {
    ...
    fn on_use(&self, game: &mut crate::game::Game, server: &mut Server, item: MutexGuard<InventorySlot>, slot: usize, user: hecs::Entity, target: Option<crate::item::item::BlockUseTarget>) -> SysResult {
        // TODO reduce in gms
